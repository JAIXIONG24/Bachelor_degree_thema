...
$query="select distinct User_tabuken.userid, User_tabuken.username from User_tabuken left join Indi_tabuken on User_tabuken.date=Indi_tabuken.date left join Pra_tabuken on Indi_tabuken.praid=Pra_tabuken.praid where kind = 2 && access=1 group by userid";
...
foreach($rec as $row ){
  ...
  $query1="select praid,count(*) as ppp from User_tabuken natural join Indi_tabuken where userid='$uid' && kind=2 && access=1 group by praid";
...
$ruikei=array();
  ...
  echo "<td>";
  echo "<form action='k_region2_indi.php' method='post'>";
...
echo "</table>";
  ...
  if($g=='4'){
    ...
    $query="select distinct User_tabuken.userid, User_tabuken.username from User_tabuken left join Indi_tabuken on User_tabuken.date=Indi_tabuken.date left join Pra_tabuken on Indi_tabuken.praid=Pra_tabuken.praid where kind = 2  && User_tabuken.graid like '_$g%' &&  access=1 && User_tabuken.date like '$y%'  group by userid";
    $stmt = $dbh->query($query);
    $rec = $stmt->fetchAll(PDO::FETCH_ASSOC);
  ...
  $query="select distinct User_tabuken.userid, User_tabuken.username from User_tabuken left join Indi_tabuken on User_tabuken.date=Indi_tabuken.date left join Pra_tabuken on Indi_tabuken.praid=Pra_tabuken.praid where kind = 2  && User_tabuken.graid like '$gr%' && access=1 group by userid";
  $stmt = $dbh->query($query);
  $rec = $stmt->fetchAll(PDO::FETCH_ASSOC);
  ...
  $query="select distinct User_tabuken.userid, User_tabuken.username from User_tabuken left join Indi_tabuken on User_tabuken.date=Indi_tabuken.date left join Pra_tabuken on Indi_tabuken.praid=Pra_tabuken.praid where kind = 2  && User_tabuken.graid like '$gr%' && User_tabuken.graid like '_$g%' && access=1 && User_tabuken.date like '$y%' group by userid";
  $stmt = $dbh->query($query);
  $rec = $stmt->fetchAll(PDO::FETCH_ASSOC);
  ...
  echo "<tr><th>学生id</th><th>学生名</th><th>累計時間</th><th></th></tr>";
    ...
    $query="select distinct User_tabuken.userid, User_tabuken.username, User_tabuken.graid, User_tabuken.date from User_tabuken left join Indi_tabuken on User_tabuken.date=Indi_tabuken.date left join Pra_tabuken on Indi_tabuken.praid=Pra_tabuken.praid where kind = 2 && access=1 group by userid";
    $stmt = $dbh->query($query);
    $rec = $stmt->fetchAll(PDO::FETCH_ASSOC);
