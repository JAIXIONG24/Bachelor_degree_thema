...
$query="insert into User_tabuken(graid,userid,username,pass,kind,access,date) values('I000','$uid','$un','$c_t',0,0,'$d')";//実習一覧の表示
...
<body>
	...
	<br>
<p>管理者登録</p>
<p>管理者ID：<?php echo $uid ?>　<?php echo $un ?>さんを登録しました。</p>
<br>
