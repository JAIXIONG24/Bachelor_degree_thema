...
$query2="update Indi_tabuken left join User_tabuken on Indi_tabuken.date=User_tabuken.date set Indi_tabuken.time='$t' where Indi_tabuken.time='$t1' and User_tabuken.userid like '%$uid%' and User_tabuken.kind=2";
...
<input type="submit" name="kensaku" value="地域創生2のID：<?php echo $uid ?>　<?php echo $na ?>さんの履歴へ戻る" class="btn btn-outline-dark">
</form>
