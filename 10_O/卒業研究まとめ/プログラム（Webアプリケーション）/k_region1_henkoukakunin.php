...
if($_POST['delete']){
  ...
  ?>
   ...
   <form action="k_region1_henkoudelete.php" method="post"><!--管理者登録ボタン-->
 ...
 <?php
  ...
  ?>
   ...
   <form action="k_region1_henkoukanryo.php" method="post"><!--管理者登録ボタン-->
     <input type="hidden" name="uid" value="<?php echo $uid; ?>">
...
<br>
 ...
 <br>
 <form action="k_region1_henkou.php" method="post"><!--管理者登録ボタン-->
   <input type="hidden" name="uid" value="<?php echo $uid; ?>">
